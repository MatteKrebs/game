...
h3.innerHTML = "The rules are simple:<br><span style='font-size:24px'>catch as many stressed emojis as you can and try to exceed stress LVL 100.</span><br><span style='font-size:20px'>Good luck</span>"
